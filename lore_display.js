const NEW_LORE_LIST = [
  'Wow, an abandoned starfighter.  I wonder what would happen if I got in this thing?  Maybe I\'m an Epic Starfighter Pilot and this is my legacy?', //asign a skill
  'Hmm, maybe it needs some fixing.  Maybe I can work on the systems and weapons and give it some capacity and firepower.  Then we\'re flying!', //cap = 1 power =2 
  'Cool, this thing can do some things now!  Let\'s practice piloting this thing and git gud. Maybe we\'re ready for some serious Starfighting?', // total skill = 15
  'OK, this hunk of junk is only getting so far.  I think it might be time to go back to the drawing board and Retrofit our starfighter.', // retrofit
  'Well, I guess we used the original parts to start up a Armada or something.  Retrofit our ship frequently and build it up to starfight.', // retrofit both
  'This Armada and all these new weapons and systems are awesome.  We\'re still a ways from Settling a Space War - keep building Armada.', // Armada cap = 5, power = 20
  ...
  'A true leader is needed to conquer the galaxy.  As I reach accolade after accolate, I can\'t help but wonder where this journey will take us.', // leader up = 20 ?
  'I can\'t help but feel that there\'s something great out there, and I have to do some soul searching.  This will help me develop my leadership.', //space war in inner soulo 
  'I feel it\'s time to grow our legend around the galaxy and take on these missions.  Enduring these hardships will teach us a lot about efficiency. ', //complete 12 missions
  'Yes, this is working.  As we\'re completing these missions, we are learning much about ourselves and opening up more avenues to get stronger.', //complete 20 missions
  'Well, now I\'m curious.  Can I Settle a War without any skill?  Can I rely on my Armadas and Leadership alone?', //settle a war with zero skill
  'I am drawn to a mysterious belief that I\'m special.  I think if I spend time searching my Inner Soulo, I\'ll discover what\'s so special about me.', //make provenance
  'Wow, turns out I am special.  I seem to have some pre-natural ability.  I wonder what it does?  I think I will have to continue my journey.', //have 33.33 pre-eminence
  'That really is something.  Time is going faster now, that or I can do more with my time?  I\'m not really sure, but it\'s time to lead.', // leader up = 40
  '1e9, that\'s a billion, right?  Is there anyone that\'s got a billion skill points?  Do people even consider themselves as having skill points?', //billion skill
